...
public class CategoryController {
    ...
    public List<Category> index(@AuthenticationPrincipal User user) { // AuthenticationPrincipal = Usuário logado
...
//        category.setId(id);
//        category.setUser(user);
        BeanUtils.copyProperties(category, oldCategory, "id", "user"); // Copia as propriedades de um pro outro
